...
export declare function buscarPorPlaca(req: AuthRequest, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function buscarMotoristaPorCpf(req: AuthRequest, res: Response): Promise<Response<any, Record<string, any>>>;
...
//# sourceMappingURL=veiculos.controller.d.ts.map